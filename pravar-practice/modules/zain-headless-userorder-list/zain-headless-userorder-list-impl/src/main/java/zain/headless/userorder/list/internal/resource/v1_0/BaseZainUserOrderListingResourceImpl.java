...
public abstract class BaseZainUserOrderListingResourceImpl
	implements ZainUserOrderListingResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/zain-headless-userorder-list/v1.0/getUserOrderList' -d $'{"end": ___, "fromDate": ___, "requestType": ___, "serviceName": ___, "start": ___, "toDate": ___, "userId": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(
				name = "ZainUserOrderListing"
			)
		}
	)
	@javax.ws.rs.Consumes({"application/json", "application/xml"})
	@javax.ws.rs.Path("/getUserOrderList")
	@javax.ws.rs.POST
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public UserOrderList postGetUserOrderList(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.ws.rs.QueryParam("channelId")
			Integer channelId,
			Resuest resuest)
		throws Exception {
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseZainUserOrderListingResourceImpl.class);
